...
%ODE solver
[t,solution]= ode15s(@(t,x) optimization_modelv2(t,x,p,o), [0, 57], y0);
[~,q_gas,pCH4g,pCO2g]=cellfun(@(t,x) optimization_modelv2(t,x,p,o),num2cell(t),num2cell(solution,2),'uni',0);
...
%Variable for objectivity function, different for each mixing time
c=0.2126;

%Objectivity function to maximalize biogas stream and methane percentage content
Z=-(pCH4g+c*q_gas);
end