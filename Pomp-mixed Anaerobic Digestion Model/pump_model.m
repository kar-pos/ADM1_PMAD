...
% Rate equations in the 1st part of reactor
...
% Rate equations in the 2nd part of reactor
rate(7) = p.k_ch * x(15); 
rate(8) = p.k_pr * x(16); 
rate(9) = p.k_li * x(17); 
rate(10) = p.k_dec * x(18); 

%Rate equations in the 3rd part of reactor
rate(11) = p.k_ch * x(23); 
rate(12) = p.k_pr * x(24); 
rate(13) = p.k_li * x(25); 
